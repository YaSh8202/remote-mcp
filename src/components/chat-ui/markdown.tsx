...
const CodeBlock = ({
	...
	if (inline) {
		return (
			<code
				className={cn(
					"rounded border bg-muted px-1 py-0.5 font-semibold",
					className,
				)}
				{...props}
			>
	...
	return (
		<div className="my-4">
			...
			<div className="overflow-x-auto !rounded-t-none rounded-b-lg bg-black p-4 text-white">
				<SyntaxHighlighter language={language} code={codeString} />
			</div>
		</div>
	);
};
...
const MarkdownImpl = ({ children, className }: MarkdownProps) => {
	return (
		<div
