...
- **Chat Feature**: Remote MCP now includes a chat interface, allowing you to interact with your MCP servers directly from the web app.
- **OAuth 2.1 Authentication**: We've implemented OAuth 2.1 for MCP server authorization, providing a more secure and streamlined authentication process.
- **New Landing Page**: The landing page has been updated to provide a better overview of Remote MCP's features and capabilities.
